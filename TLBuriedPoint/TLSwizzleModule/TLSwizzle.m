...
@implementation NSObject (TLSwizzle)

+ (BOOL)tl_swizzleMethod:(SEL)origSel_ withMethod:(SEL)altSel_ error:(NSError**)error_ {
#if OBJC_API_VERSION >= 2
...
+ (BOOL)tl_swizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError**)error_ {
	return [GetClass((id)self) tl_swizzleMethod:origSel_ withMethod:altSel_ error:error_];
}
